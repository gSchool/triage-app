...
- [`resources/user_stories.md`](resources/user_stories.md) — acceptance criteria for Submit and Resolve flows
- [`resources/bug_report.md`](resources/bug_report.md) — two known bugs with reproduction steps
